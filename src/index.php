...
<html lang="en">
  <head>
    <?php
      $title = "Opuqide";
      $description = "the frickin home page";
      $path = "/";
  ...
  <body class="dark-theme github">
    <div class="fullscreen">
      <div class="background" style="background-image: url('/static/images/KIBBY.jpeg');"></div>
      <div class="center-object">
        <div class="container">
          <section class="me unset">
            ...
            <div class="unset">
              <h1 class="title dropshadow-small">Opuqide</h1>
          ...
          <div class="buttons">
            <a href="https://discord.gg/444nMqksmu" class="btn discord-dropshadow white-text animation hover" target="_blank">Discord</a>
          </div>
        </div>
      </div>
